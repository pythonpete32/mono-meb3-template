# 🚀 Turborepo starter NextJS with Shadcn/UI Wagmi and Foundry
...
Turborepo starter **NextJS** with **Shadcn/UI**, **WAGMI**, & **Foundry** pre-configured for shared UI components powered by:
...
- `dapp`: a [Next.js](https://nextjs.org/) app
- `contracts`: a [Foundry]() project
